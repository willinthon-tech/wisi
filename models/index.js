...
const Feriado = require("./Feriado")(sequelize);

// Asociaciones para NovedadMaquinaRegistro
NovedadMaquinaRegistro.belongsTo(Libro, {
  foreignKey: "libro_id",
  onDelete: "RESTRICT",
});
Libro.hasMany(NovedadMaquinaRegistro, {
  foreignKey: "libro_id",
  onDelete: "RESTRICT",
});

NovedadMaquinaRegistro.belongsTo(Maquina, {
  foreignKey: "maquina_id",
  onDelete: "RESTRICT",
});
Maquina.hasMany(NovedadMaquinaRegistro, {
  foreignKey: "maquina_id",
  onDelete: "RESTRICT",
});

NovedadMaquinaRegistro.belongsTo(Empleado, {
  foreignKey: "empleado_id",
  onDelete: "RESTRICT",
});
Empleado.hasMany(NovedadMaquinaRegistro, {
  foreignKey: "empleado_id",
  onDelete: "RESTRICT",
});

// Asociaciones para IncidenciaGeneral
IncidenciaGeneral.belongsTo(Libro, {
  foreignKey: "libro_id",
  onDelete: "RESTRICT",
});
Libro.hasMany(IncidenciaGeneral, {
  foreignKey: "libro_id",
  onDelete: "RESTRICT",
});
...
Departamento.belongsTo(Sala, {
  foreignKey: "sala_id",
  as: "Sala",
  onDelete: "RESTRICT",
});
Sala.hasMany(Departamento, {
  foreignKey: "sala_id",
  as: "Departamentos",
  onDelete: "RESTRICT",
});
...
Area.belongsTo(Departamento, {
  foreignKey: "departamento_id",
  as: "Departamento",
  onDelete: "RESTRICT",
});
Departamento.hasMany(Area, {
  foreignKey: "departamento_id",
  as: "Areas",
  onDelete: "RESTRICT",
});
...
HorarioEmpleado.belongsTo(Empleado, {
  foreignKey: "empleado_id",
  onDelete: "RESTRICT",
});
HorarioEmpleado.belongsTo(Horario, {
  foreignKey: "horario_id",
  onDelete: "RESTRICT",
});
Empleado.hasMany(HorarioEmpleado, {
  foreignKey: "empleado_id",
  onDelete: "RESTRICT",
});
Horario.hasMany(HorarioEmpleado, {
  foreignKey: "horario_id",
  onDelete: "RESTRICT",
});
...
Attlog.belongsTo(Dispositivo, {
  foreignKey: "dispositivo_id",
  onDelete: "RESTRICT",
});
Dispositivo.hasMany(Attlog, {
  foreignKey: "dispositivo_id",
  onDelete: "RESTRICT",
});
...
Horario.hasMany(Bloque, {
  foreignKey: "horario_id",
  as: "bloques",
  onDelete: "RESTRICT",
});
Bloque.belongsTo(PlantillaHorario, {
  foreignKey: "plantilla_horario_id",
  as: "PlantillaHorario",
  onDelete: "RESTRICT",
});
PlantillaHorario.hasMany(Bloque, {
  foreignKey: "plantilla_horario_id",
  onDelete: "RESTRICT",
});
...
PlantillaHorario.belongsTo(Sala, {
  foreignKey: "sala_id",
  onDelete: "RESTRICT",
});
...
ExcepcionHorario.belongsTo(Empleado, {
  foreignKey: "empleado_id",
  onDelete: "RESTRICT",
});
Empleado.hasMany(ExcepcionHorario, {
  foreignKey: "empleado_id",
  onDelete: "RESTRICT",
});
ExcepcionHorario.belongsTo(PlantillaHorario, {
  foreignKey: "plantilla_horario_id",
  onDelete: "RESTRICT",
});
PlantillaHorario.hasMany(ExcepcionHorario, {
  foreignKey: "plantilla_horario_id",
  onDelete: "RESTRICT",
});

// Asociaciones para Feriado
Feriado.belongsTo(Sala, { foreignKey: "sala_id", onDelete: "RESTRICT" });
Sala.hasMany(Feriado, { foreignKey: "sala_id", onDelete: "RESTRICT" });

// Asociaciones para ControlLlaveRegistro
ControlLlaveRegistro.belongsTo(Libro, {
  foreignKey: "libro_id",
  as: "Libro",
  onDelete: "RESTRICT",
});
ControlLlaveRegistro.belongsTo(Llave, {
  foreignKey: "llave_id",
  as: "Llave",
  onDelete: "CASCADE",
});
ControlLlaveRegistro.belongsTo(Empleado, {
  foreignKey: "empleado_id",
  as: "Empleado",
  onDelete: "CASCADE",
});
Libro.hasMany(ControlLlaveRegistro, {
  foreignKey: "libro_id",
  as: "ControlLlaveRegistros",
  onDelete: "RESTRICT",
});
Llave.hasMany(ControlLlaveRegistro, {
  foreignKey: "llave_id",
  as: "ControlLlaveRegistros",
  onDelete: "CASCADE",
});
Empleado.hasMany(ControlLlaveRegistro, {
  foreignKey: "empleado_id",
  as: "ControlLlaveRegistros",
  onDelete: "CASCADE",
});
...
NovedadMesaRegistro.belongsTo(Libro, {
  foreignKey: "libro_id",
  as: "Libro",
  onDelete: "RESTRICT",
});
NovedadMesaRegistro.belongsTo(Mesa, {
  foreignKey: "mesa_id",
  as: "Mesa",
  onDelete: "CASCADE",
});
NovedadMesaRegistro.belongsTo(Empleado, {
  foreignKey: "empleado_id",
  as: "Empleado",
  onDelete: "CASCADE",
});
Libro.hasMany(NovedadMesaRegistro, {
  foreignKey: "libro_id",
  as: "NovedadMesaRegistros",
  onDelete: "RESTRICT",
});
Mesa.hasMany(NovedadMesaRegistro, {
  foreignKey: "mesa_id",
  as: "NovedadMesaRegistros",
  onDelete: "CASCADE",
});
Empleado.hasMany(NovedadMesaRegistro, {
  foreignKey: "empleado_id",
  as: "NovedadMesaRegistros",
  onDelete: "CASCADE",
});
