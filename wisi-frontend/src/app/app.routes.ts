...
export const routes: Routes = [
  ...
  {
    path: 'cumplemes',
    loadComponent: () => import('./components/cumplemes/cumplemes.component').then(m => m.CumpleMesComponent),
  ...
  {
    path: 'carnet',
    loadComponent: () => import('./components/carnet/carnet-list/carnet-list.component').then(m => m.CarnetListComponent),
    canActivate: [AuthGuard]
  },
  {
    path: 'areas',
  ...
  {
    path: 'empleados-borrados',
    loadComponent: () => import('./components/empleados/empleados-borrados/empleados-borrados.component').then(m => m.EmpleadosBorradosComponent),
    canActivate: [AuthGuard]
  },
  {
  ...
  {
    path: 'marcaje-personal',
    loadComponent: () => import('./components/marcajes/marcaje-personal/marcaje-personal.component').then(m => m.MarcajePersonalComponent),
    canActivate: [AuthGuard]
  },
  {
    path: 'horarios',
